    ...
    <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div
          className={`relative border-2 border-dashed rounded-xl p-8 text-center transition-colors cursor-pointer ${
            file
              ...
              : "border-[#D4C5A9]/50 hover:border-burgundy/40 bg-white"
          }`}
      ...
      <div>
        ...
        <input
          ...
          className="w-full bg-white border border-[#D4C5A9]/50 rounded-lg px-4 py-2.5 text-sm text-charcoal placeholder:text-[#8B7355]/50 focus:border-burgundy focus:ring-0 transition-colors"
        />
      </div>
