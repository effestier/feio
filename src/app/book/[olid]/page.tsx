            ...
            <div className="mt-4 space-y-3">
              ...
              {!gutenbergId && !iaHasText && iaUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  className="flex items-center justify-center gap-2 w-full py-3 bg-charcoal text-white rounded-lg font-medium text-sm hover:bg-charcoal-light transition-colors"
                >
              ...
              {seBook && (
                <div>
                  ...
                  >
                    Standard Ebooks
                    {seBook.epubUrl && <span className="text-xs text-white/60 ml-1">(EPUB)</span>}
                  </a>
                </div>
              )}
              ...
              <div className="flex flex-wrap gap-2">
                {subjects.map((subject) => (
                  <Link
                    ...
                    className="px-3 py-1 text-xs bg-white border border-charcoal/10 rounded-full hover:border-burgundy/30 hover:text-burgundy transition-colors"
                  >
                    {subject}
                  </Link>
                ))}
